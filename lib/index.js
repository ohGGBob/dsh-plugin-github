...
function apply(ctx, config) {
  ...
  ctx.tools.register(defineTool({
    name: "github_push",
    description: "Publish a local project directory to GitHub. Point `path` at a local folder; it will `git init` (when needed), commit, create a public or private repository under your account (when it does not already exist), and push to the `main` branch. Requires a GITHUB_TOKEN. Re-run on the same folder to push only the new local changes to the existing repository.",
    parameters: {
